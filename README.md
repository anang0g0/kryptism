...
============================================================================================
まあ、アノニマイザを誰かやりませんかと言う話なんですけど。それ以外の方法は凖同型案号とか検索暗号で
自分宛のメッセージを識別するとかですかね。その場合は検索サイトがメッセージの受け渡しをするんでしょうけど。
...
メッセージの受け渡しにアノニマイザを使うのはアリだと思う。分散通信にしても、回覧板方式でも
インフラがいる。メッセージのやりとりを匿名化するにはシステム的なしかけが必要。検索サイトを使ってメッセージを
受け取る方法を考えます。いずれにしても直接暗号文をやりとりすると、どちらかが監視されている時に関係を
マークされます。忘却転送も使えるかもしれないけどよく解らん。
