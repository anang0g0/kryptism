...
<hr>
2018/08/06</br>
さて去年からの成果物をここに説明しておきます。置換群の共役元を使った暗号は連立方程式で解ける場合と、解けない場合があるということで確実な解読法とは言えないことが実験の結果わかりました。また、第二の成果物として以下の暗号系を提示します。</br>
</br>
置換群を用いた公開鍵暗号</br>
...
これもまだ確定はしていないのですが、もしｒを決定する方法があれば共役元探索問題の代わりに使える方法だと思います。
